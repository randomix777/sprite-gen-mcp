#!/usr/bin/env python3
"""
处理 enemy_general 和 chain_lock_door
"""
import numpy as np
...
def process_asset(filepath):
    ...
    try:
        ...
        # 缩放适配
        effective_w = TARGET_W - 2 * int(TARGET_W * 0.05)
        effective_h = TARGET_H - 2 * int(TARGET_H * 0.05)
...
def main():
    ...
    files_to_fix = [
        project_dir / 'assets/sprites/enemies/enemy_general.png',
        project_dir / 'assets/cover/chain_lock_door.png',
    ]
    
    print(f"处理 {len(files_to_fix)} 个剩余资产...\n")
