...
DIST_THRESHOLD = 30.0  # 更低阈值
BBOX_PADDING = 60  # 更大填充
...
def process_weapon(filepath):
    ...
    try:
        ...
        # 缩放适配 512x768（使用更大的填充以增大主体比例）
        margin_x = int(TARGET_W * 0.04)  # 更小边距
        margin_y = int(TARGET_H * 0.02)  # 更小边距
        ...
        ox = (TARGET_W - nw) // 2
        oy = TARGET_H - nh - int(TARGET_H * 0.02)  # 更靠近底部
...
def main():
    ...
    weapons_to_fix = ['flintlock_musket.png', 'pump_shotgun.png', 'bolt_action_rifle.png']
