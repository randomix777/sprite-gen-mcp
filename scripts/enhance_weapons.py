...
DIST_THRESHOLD = 40.0  # 降低阈值，保留更多细节
BBOX_PADDING = 50      # 增加边距
...
def process_weapon(filepath, output_path=None):
    ...
    try:
        ...
        ox = (TARGET_W - nw) // 2
        oy = TARGET_H - nh - int(TARGET_H * 0.05)  # 底部留 5% 边距
...
def main():
    ...
    if args.file:
        process_weapon(project_dir / args.file)
        return
