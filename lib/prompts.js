...
export const STYLE_PRESETS = {
  ...
  fps_weapon: {
    ...
    prompt_suffix: 'FPS weapon sprite, clean side-profile view, detailed mechanical parts, metallic sheen, game HUD quality, transparent background ready.',
  ...
  inventory: {
    ...
    prompt_suffix: 'Inventory item icon, standalone object on transparent background, clear silhouette, isometric or front view, game HUD quality, clean edges.',
  ...
  vfx_effects: {
    ...
    prompt_suffix: 'VFX particle effect sprite, glowing magical effects, energy bursts, smoke trails, transparent background, game FX quality, dynamic pose.',
  ...
  neon_cyber: {
    ...
    prompt_suffix: 'Neon-lit cyberpunk aesthetic, glowing edges, dark background with bright accent colors, futuristic tech visual, synthwave palette, electric blue and magenta highlights.',
